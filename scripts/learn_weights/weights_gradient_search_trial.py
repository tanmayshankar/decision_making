...
number_val = 5
value_functions = value_functions.reshape((number_val,number_val,discrete_size))

cost_maps = npy.zeros(shape=(number_costmaps,length,width))

#Defining collective basis functions. 
basis_functions = npy.zeros(shape=(number_val, length, width))
...
reward_weights = npy.zeros(number_val)
